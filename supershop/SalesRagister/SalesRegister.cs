...
namespace supershop 
{
    ...
    {
        /// <summary>
        ///  Author : SharkTankSolutions
        ///  Email:   info@sharktanksolutions.com        ///  
        ///  Web:         http://sharktanksolutions.com
        /// </summary>
        /// <param name="aa"></param>
        /// Developed by SharkTankSolutions
        

        public SalesRegister()
        {
            //MessageBox.Show("going to sales");
            InitializeComponent();
            //MessageBox.Show("After Initial comp");
            ...
            //MessageBox.Show("after going to sales");
        ...
        public void DiscountCalculation()
        {
           ...
           // btnPayment.Text = "Pay = " + payable.ToString();
            ...
            tabPageSR_Counter.Text = "Terminals (" + dgrvSalesItemList.RowCount.ToString() + ")";
            //Sam 
            tabPageSR_Counter.BackColor = Color.Red;
        ...
        private void btnSuspend_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // lblTotalItems.Text = "0";
                ...
                tabPageSR_Counter.Text = "Terminals!";
                this.tabPageSR_Payment.Parent = null; //Hide payment tab
                txtBarcodeReaderBox.Focus();
            }
            catch
        ...
        ///// Open Payment Tab to receive amount
        ...
        private void flowLayoutPanelItemList_Paint(object sender, PaintEventArgs e)
        {
